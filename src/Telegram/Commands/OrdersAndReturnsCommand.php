 ...
 */
class OrdersAndReturnsCommand extends Command implements MainMenuButtonInterface
{

    protected string $name = 'orders_and_returns';

    protected string $description = 'Заказы и возвраты';
